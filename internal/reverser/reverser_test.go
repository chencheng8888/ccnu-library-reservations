...
//import (
//	"context"
//	auther2 "libary-reservations/internal/auther"
//	"testing"
//	"time"
//)
//
...
//
//	stuID, pwd := auther2.LoadInfo()
//	if stuID == "" || pwd == "" {
//		t.Fatal("STUID or PASSWORD not set in .env file")
//	}
//
//	auther := auther2.NewAuther()
...
//
//	seats, err := reverser.GetSeatsByTime(context.Background(), stuID, "101699179", startTime, endTime)
//	if err != nil {
